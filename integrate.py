...
JOBS = {
    ...
    "kfiag": ("Kf_isAbelianGalois", ["Kf_isGalois", "Kf_aut_involutive"]),
    "logcn": ("log_classNumber_Kf_le", ["Kf_one_lt_finrank", "q3_log_sum_le",
        "log_discr_Kf_le", "log_classNumber_le_log_discr"]),
    "unitssq": ("units_sq_index_le", ["index_powMonoidHom_two_le_of_closure"]),
    "logm": ("log_m_le", []),
